...
package proto_fleet // import "github.com/synerex/proto_fleet"
...
func (*FleetService) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_018e63770186a21c, []int{0}
}
...
func (*FleetService_ShareRideSerivce) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_018e63770186a21c, []int{0, 0}
}
...
func (*FleetService_DeliverSerivce) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_018e63770186a21c, []int{0, 1}
}
...
func (*Fleet) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_018e63770186a21c, []int{1}
}
...
func (*Fleet_Coord) Descriptor() ([]byte, []int) {
	return fileDescriptor_fleet_018e63770186a21c, []int{1, 0}
}
...
func init() {
	proto.RegisterType((*FleetService)(nil), "proto.fleet.FleetService")
	proto.RegisterType((*FleetService_ShareRideSerivce)(nil), "proto.fleet.FleetService.ShareRideSerivce")
	proto.RegisterType((*FleetService_DeliverSerivce)(nil), "proto.fleet.FleetService.DeliverSerivce")
	proto.RegisterType((*Fleet)(nil), "proto.fleet.Fleet")
	proto.RegisterType((*Fleet_Coord)(nil), "proto.fleet.Fleet.Coord")
}

func init() { proto.RegisterFile("fleet.proto", fileDescriptor_fleet_018e63770186a21c) }

var fileDescriptor_fleet_018e63770186a21c = []byte{
	// 484 bytes of a gzipped FileDescriptorProto
	,
}
